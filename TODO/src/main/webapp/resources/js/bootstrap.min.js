...
+function (a) {
    ...
    function b(b) {
        return this.each(function () {
            ...
            (e || !/delete|hide/.test(b)) && (e || d.data("bs.tooltip", e = new c(this, f)), "string" == typeof b && e[b]())
        })
    }
    ...
    function b(b) {
        return this.each(function () {
            ...
            (e || !/delete|hide/.test(b)) && (e || d.data("bs.popover", e = new c(this, f)), "string" == typeof b && e[b]())
        })
    }
